# -*- coding: utf-8 -*-
"""
Created on Sun Feb 24 22:49:07 2019
...
Ip = data[:,2];
x = Ip;
Q_Ip = data[:,5]; #Q_Ip means (Qc-remove)/Ip
y = Q_Ip;
...
plt.savefig('peltierCoeff_weightedLinFitNchiSqrd_noHeatFluxTerm_FINAL.png', format='png', dpi=300, bbox_inches='tight')
